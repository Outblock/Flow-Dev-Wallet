...
const ActivityList = () => {
  ...
  const flowList = flowTxs?.data || flowTxs?.transactions || (Array.isArray(flowTxs) ? flowTxs : []);
  const evmList = evmTxs?.data || evmTxs?.items || (Array.isArray(evmTxs) ? evmTxs : []);

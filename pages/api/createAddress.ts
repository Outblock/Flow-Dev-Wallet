...
async function createAccountOnEmulator({ publicKey, signatureAlgorithm, hashAlgorithm, weight }: CreateAccountParams): Promise<string> {
...
export default async function createAddress(req: NextApiRequest, res: NextApiResponse) {
  const {
    publicKey,
    network,

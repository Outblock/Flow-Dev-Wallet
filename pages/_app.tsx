...
function loadSettingsConfig(defaultNetwork: string): SettingsConfig {
 ...
 */
async function applyUrlParams(store: Record<string, any>, setStore: (s: Record<string, any>) => void): Promise<boolean> {
...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  const [store, setStore] = useState<Record<string, any>>({ network: settings.network, rpcUrl: settings.rpcUrl, autoSign: settings.autoSign });
